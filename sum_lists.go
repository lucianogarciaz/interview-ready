...
func sumListForeward(list1 *ListNode, list2 *ListNode) *ListNode {
	...
	for list1 != nil {
		num1Str = fmt.Sprintf("%s%d", num1Str, list1.Val)
		list1 = list1.Next
	}

	for list2 != nil {
		num2Str = fmt.Sprintf("%s%d", num2Str, list2.Val)
		list2 = list2.Next
	}
